...
broker_address = "5ea7583b9e2a4b688fb17bc3928614d8.s2.eu.hivemq.cloud"
broker_port = 8883
topic = "sensor/sps30"
username = "pytest"
password = "Pytest123"
...
class MQTTClient:
    def __init__(self):
        self.client = mqtt.Client(callback_api_version=mqtt.CallbackAPIVersion.VERSION2,reconnect_on_failure=True, client_id="paulo-sps30-sensor-pytest")
